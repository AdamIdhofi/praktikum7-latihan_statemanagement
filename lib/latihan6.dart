...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: BlocProvider(
        create: (context) => UniversitasBloc(), // Membuat UniversitasBloc
...
// Bloc untuk mengelola state universitas
class UniversitasBloc extends Cubit<List<dynamic>> {
  UniversitasBloc() : super([]);
...
class UniversitasList extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final universitasBloc = BlocProvider.of<UniversitasBloc>(context);
        ...
        children: [
          ...
          DropdownButton<String>(
            ...
            onChanged: (String? newValue) {
              if(newValue != null) {
                universitasBloc!.fetchData(newValue); // Panggil method fetchData dari Bloc
              }
            },
          ),
          // Widget untuk menampilkan data universitas
          BlocBuilder<UniversitasBloc, List<dynamic>>(
